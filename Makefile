...
##
BUILD_CP := "$(SRC_DIR)/$(DIR_DELIM)lib/atqa.jar"

##
# run classpath options - the classpaths needed to run the program
##
RUN_CP := "$(OUT_DIR_MAIN)$(DIR_DELIM)lib/atqa.jar"
...
jar:: classes
	 cp lib/atqa.jar $(OUT_DIR_MAIN)
	 cd $(OUT_DIR_MAIN) && jar -xf atqa.jar
	 rm $(OUT_DIR_MAIN)/atqa.jar
